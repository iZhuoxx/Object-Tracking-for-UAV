...
int main(int argc, char *argv[])
{
    ...
    if (param.takeoff_land.no_RC)
    {
        ...
        server.setCallback(f); //Set a callback function for the server. 
        //When the node program is running, the callback function will be called once to output the current parameter configuration.
