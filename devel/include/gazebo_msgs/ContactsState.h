...
struct ContactsState_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::gazebo_msgs::ContactState_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::gazebo_msgs::ContactState_<ContainerAllocator> >> _states_type;
  _states_type states;
