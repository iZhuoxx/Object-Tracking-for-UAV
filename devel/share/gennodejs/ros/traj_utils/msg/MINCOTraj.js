...
class MINCOTraj {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('des_clearance')) {
        this.des_clearance = initObj.des_clearance
      }
      else {
        this.des_clearance = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [des_clearance]
    bufferOffset = _serializer.float32(obj.des_clearance, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [des_clearance]
    data.des_clearance = _deserializer.float32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.des_clearance !== undefined) {
      resolved.des_clearance = msg.des_clearance;
    }
    else {
      resolved.des_clearance = 0.0
    }
